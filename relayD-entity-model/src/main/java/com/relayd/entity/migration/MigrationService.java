...
public abstract class MigrationService {
	...
	public static CopyRelayService newCopyRelayService(GenericJpaDao aJpaDao) {
		return CopyRelayService.newInstance(aJpaDao);
	}
	...
	void setRelayCounter(RelayCounter aRelayCounter) {
		relayCounter = aRelayCounter;
	}
